...
$user = array(
    'USER_LOGIN' => $_POST['email'],//'sokol-production@yandex.ru', #Ваш логин (электронная почта)
    'USER_HASH' => $_POST['hash'],//'f19bf63dfb658fb2d0e15bd9253224d0e212ad87', #Хэш для доступа к API (смотрите в профиле пользователя)
);
...
{
    print_r('Авторизация прошла успешно!<br/><br/>');
    require_once('mainform.php');
}
else {
    die('Авторизация не удалась, проверьте введённые данные!<br/><br/>');
}
